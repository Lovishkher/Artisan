        ...
        <div id="container" className=" px-6 sm:px-24 w-full h-full">
          ...
          <div className="flex sm:flex-row flex-col-reverse items-start sm:items-end gap-3 xl:gap-0 sm:justify-between w-full relative bottom-0 h-full">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-white text-lg">Elevate Your Space with Artisan Mastery</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div id="container" className=" px-6 sm:px-24 w-full h-full">
          <div className="flex xl:flex-row xl:gap-64 flex-col h-full justify-center xl:items-center">
            <div className="flex flex-col h-full sm:justify-center xl:gap-12 xl:text-center">
              <p className="uppercase text-xl">ARTISAN FURNITURE FOR COMFORT LIVING</p>
              <p>Discover the Elegance Below, Artisan Designs for Your Lifestyle</p>
            </div>
            <div className="flex flex-col gap-3 items-start sm:gap-9 xl:w-3/4">
              <p className="text-base"> Our website is a portal to a world where traditional craftsmanship meets modern living,
                offering a bespoke experience for those who seek elegance in comfort. Each image below is a testament to our
                dedication handcrafted designs that don&apos;t just fill spaces but enrich lifestyles. We invite you to explore our gallery of
                interiors, where every click reveals the meticulous care and passion infused into our work.
              </p>
              <Link href="/works">
