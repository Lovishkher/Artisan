          ...
          {Content.map((element: ContentType, index: number) => {
            return (
              ...
              >
                ...
                <div className="text-sm"> “Sustainable Luxury for the Conscious Dweller” Step into the future of design with our Eco-Chic Interiors.
                  We are passionate about creating spaces that not only look good but also feel good,
                  for you and the planet. Our sustainable design philosophy integrates eco-friendly materials and energy-efficient solutions
                  without compromising on style or luxury. We&apos;ll help you make responsible choices that reduce your carbon footprint while elevating your living experience. With us, sustainability is the new standard for luxury.
                  <b> For any further queries you can request a call below.</b>
                </div>
                <Link
                  href={"https://calendly.com/lovish-tradeshala/calling-with"}
                  target="_blank"
