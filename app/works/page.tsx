              ...
              <div id="container" className="px-6 sm:px-24 w-full h-full">
                <div className="grid grid-cols-1 sm:grid-cols-2 justify-between py-6 px-6 border-b-black">
                  ...
                  <div className="flex flex-col my-3 sm:my-0 sm:flex-row sm:justify-between">
                    <p> This residential space is a blend of modern luxury and traditional charm.
                      Our team transformed a classic apartment into an elegant urban retreat, featuring bespoke furniture and artisanal decor.
                      The result is a serene sanctuary that stands as a testament to our commitment to excellence in design.</p>
                    <Link
                      href={url}
                      target="_blank"
                      className={clsx(
        ...
        <div id="container" className=" px-6 sm:px-24 w-full h-full">
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div>
              ...
              <Link
                href="https://calendly.com/lovish-tradeshala/30min"
